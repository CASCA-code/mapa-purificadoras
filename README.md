...
| `userscripts/purificadoras-scout.user.js` | Tampermonkey Scout sobre google.com/maps (**cero** API key; **v1.8.2** HUD ext version, menos U-turns/thrash, turn-only ≥40°, skip 2–3 WP) |
