...
| `userscripts/purificadoras-scout.user.js` | Tampermonkey Scout sobre google.com/maps (**cero** API key; **v1.7.3** speed −/+ (sin range), sin blur HUD, routeBusy watchdog + look-ahead cruces + POV→trayecto + cobertura calles) |
