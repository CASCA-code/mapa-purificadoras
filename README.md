...
| `userscripts/purificadoras-scout.user.js` | Tampermonkey Scout sobre google.com/maps (**cero** API key; **v1.7.2** speed fijo (blur ante ext) + look-ahead cruces + POV→trayecto + cobertura calles) |
