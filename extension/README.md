...
Companion del userscript Tampermonkey: **Purificadoras Scout v1.8.2+** (cobertura calles + **rota POV antes de avanzar**; la extensión es el pasito Left/Right/Up confiable).
